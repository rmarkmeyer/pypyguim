...
##%EXTRACLASSCODE
     def saveBack(self):
          self.globals.code = gettext(self.bigTA)
     
     def setGlobals(self, globals):
          self.globals = globals
          settext(self.bigTA, globals.code)
     ...
     def reconfigure(self, event):
          if event.widget == self.root:
               if event.width != self.lastwidth or event.height != self.lastheight:
                    ...
                    self.bigTA.place(width=self.lastwidth-12, height=self.lastheight-40)
     ...
     def post_initialization(self):
          ...
          self.root.title("Code window")
##%ENDCODE

     def __init__(self):
          self.root=Tk()
          self.root.geometry("773x510")
...
#--------------------widget making code, do not change anything from here to the end of the file!--------------------
          ...
          self.applyB.place(x=327,y=478, width=67, height=26)
          ...
          self.cancelB.place(x=395,y=478, width=67, height=26)
          ...
          self.bigTA.place(x=11,y=4, width=766, height=472)
          self.bigTA.settext("")
...
##%VERSION=PY2
##%CLASS_STYLE=class
##%WHENWRITTEN=Sat Jun 04 10:10:22 EDT 2022
